classdef burger_shop_2d < burger_shop
...
%   Covered by the 3-clause BSD License (see LICENSE file for details).
    ...
    methods
        function initialize(sim)
            ...
            sim.T = 6*3*3;          %% T, number of simulation periods
            sim.R = [2 2];          %% R, dimension(s) of simulation runs
            ...
            sim.register_process(bg2_order(...
                struct( 'name', 'order', ...
                        'f', 6*3, ...
                        't0', 1, ...
                        'tau', 0) ));
            sim.register_process(bg2_deliver(...
                struct( 'name', 'deliver', ...
                        'f', 6 , ...
                        't0', 2, ...
                        'tau', 1) ));
            sim.register_process(bg2_defrost(...
                struct( 'name', 'defrost', ...
                        'f', 2, ...
                        't0', 1, ...
                        'tau', 1) ));
            sim.register_process(bg2_grill(...
                struct( 'name', 'grill', ...
                        'f', 1, ...
                        't0', 1, ...
                        'tau', 0) ));
